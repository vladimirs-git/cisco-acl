...
class Test(Helpers):
    ...
    def test_valid__eq__(self):
        ...
        wild_3_3 = Address(WILD_3_3, platform="nxos")
        subnet30 = Address(SUBNET30, platform="ios")
    ...
    def test_valid__lt__(self):
        ...
        for line1, line2, req_lt, req_le, req_gt, req_ge in [
            ...
            (WILD00, WILD_3_3, True, True, False, False),
            (WILD00, WILD_252, True, True, False, False),
            ...
            (WILD30, WILD_3_3, True, True, False, False),
            (WILD30, WILD_252, True, True, False, False),
            (WILD30, IOS_ADDGR, True, True, False, False),
            # wildcard="10.0.0.1 0.0.0.0", ipnet="10.0.0.1/32"
            (WILD32, WILD32, False, True, False, True),
            (WILD32, WILD_3_3, True, True, False, False),
            (WILD32, WILD_252, True, True, False, False),
            (WILD32, IOS_ADDGR, True, True, False, False),
            # wildcard="10.0.0.0 0.0.3.3", ipnet=None
            (WILD_3_3, WILD_3_3, False, True, False, True),
            (WILD_3_3, WILD_252, True, True, False, False),
            (WILD_3_3, IOS_ADDGR, True, True, False, False),
            # wildcard="10.0.0.0 255.255.255.252", ipnet=None
            (WILD_252, WILD_252, False, True, False, True),
            (WILD_252, IOS_ADDGR, True, True, False, False),
    ...
    def test_valid__lt__sort(self):
        ...
        for items in [
            ...
            [Address(WILD00), Address(WILD_3_3)],
            [Address(WILD00), Address(WILD_252)],
            [Address(WILD00), Address(IOS_ADDGR)],
            # wildcard="10.0.0.0 0.0.0.3", ipnet="10.0.0.0/30"
            [Address(WILD30), Address(WILD30)],
            [Address(WILD30), Address(WILD32)],
            [Address(WILD30), Address(WILD_3_3)],
            [Address(WILD30), Address(WILD_252)],
            [Address(WILD30), Address(IOS_ADDGR)],
            # wildcard="10.0.0.1 0.0.0.0", ipnet="10.0.0.1/32"
            [Address(WILD32), Address(WILD32)],
            [Address(WILD32), Address(WILD_3_3)],
            [Address(WILD32), Address(WILD_252)],
            [Address(WILD32), Address(IOS_ADDGR)],
            # wildcard="10.0.0.0 0.0.3.3", ipnet=None
            [Address(WILD_3_3), Address(WILD_3_3)],
            [Address(WILD_3_3), Address(WILD_252)],
            [Address(WILD_3_3), Address(IOS_ADDGR)],
            # wildcard="10.0.0.0 255.255.255.252", ipnet=None
            [Address(WILD_252), Address(WILD_252)],
            [Address(WILD_252), Address(IOS_ADDGR)],
            # line="group-object NAME", ipnet=None
