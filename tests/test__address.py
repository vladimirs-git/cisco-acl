...
class Test(Helpers):
    ...
    def test_valid__platform(self):
        ...
        for kwargs, req_d, platform_new, req_new_d in [
            ...
            (dict(platform="ios", line=PREFIX32), WILD32_D, "ios", HOST_D),
            (dict(platform="ios", line=SUBNET00), WILD00_32_D, "ios", HOST_0_D),
            (dict(platform="ios", line=SUBNET30), WILD_NC252_D, "ios", WILD_NC252_D),
            (dict(platform="ios", line=SUBNET32), WILD_ANY_D, "ios", ANY_D),
            (dict(platform="ios", line=WILD00), WILD_ANY_D, "ios", ANY_D),
            (dict(platform="ios", line=WILD30), WILD30_D, "ios", WILD30_D),
            (dict(platform="ios", line=WILD32), WILD32_D, "ios", HOST_D),
            ...
            (dict(platform="ios", line=PREFIX32), WILD32_D, "nxos", PREFIX32_D),
            (dict(platform="ios", line=SUBNET00), WILD00_32_D, "nxos", PREFIX00_32_D),
            (dict(platform="ios", line=SUBNET30), WILD_NC252_D, "nxos", WILD_NC252_D),
            (dict(platform="ios", line=SUBNET32), WILD_ANY_D, "nxos", ANY_D),
            (dict(platform="ios", line=WILD00), WILD_ANY_D, "nxos", ANY_D),
            (dict(platform="ios", line=WILD30), WILD30_D, "nxos", PREFIX30_D),
            (dict(platform="ios", line=WILD32), WILD32_D, "nxos", PREFIX32_D),
            ...
            (dict(platform="ios", line=HOST), HOST_D, "nxos", PREFIX32_D),
            (dict(platform="ios", line=IOS_ADDGR), IOS_ADDGR_D, "nxos", CNX_ADDGR_D),
            # nxos to nxos
            (dict(platform="nxos", line=PREFIX00), PREFIX00_D, "nxos", ANY_D),
            (dict(platform="nxos", line=PREFIX30), PREFIX30_D, "nxos", PREFIX30_D),
            (dict(platform="nxos", line=PREFIX32), PREFIX32_D, "nxos", PREFIX32_D),
            (dict(platform="nxos", line=SUBNET00), WILD00_32_D, "nxos", PREFIX00_32_D),
            (dict(platform="nxos", line=SUBNET30), WILD_NC252_D, "nxos", WILD_NC252_D),
            (dict(platform="nxos", line=SUBNET32), WILD_ANY_D, "nxos", ANY_D),
            (dict(platform="nxos", line=WILD00), WILD_ANY_D, "nxos", ANY_D),
            (dict(platform="nxos", line=WILD30), WILD30_D, "nxos", PREFIX30_D),
            (dict(platform="nxos", line=WILD32), WILD32_D, "nxos", PREFIX32_D),
            ...
            (dict(platform="nxos", line=HOST), HOST_D, "nxos", PREFIX32_D),
            (dict(platform="nxos", line=CNX_ADDGR), CNX_ADDGR_D, "nxos", CNX_ADDGR_D),
            # nxos to ios
            (dict(platform="nxos", line=PREFIX00), PREFIX00_D, "ios", ANY_D),
            (dict(platform="nxos", line=PREFIX30), PREFIX30_D, "ios", WILD30_D),
            (dict(platform="nxos", line=PREFIX32), PREFIX32_D, "ios", HOST_D),
            (dict(platform="nxos", line=SUBNET00), WILD00_32_D, "ios", HOST_0_D),
            (dict(platform="nxos", line=SUBNET30), WILD_NC252_D, "ios", WILD_NC252_D),
            (dict(platform="nxos", line=SUBNET32), WILD_ANY_D, "ios", ANY_D),
            (dict(platform="nxos", line=WILD00), WILD_ANY_D, "ios", ANY_D),
            (dict(platform="nxos", line=WILD30), WILD30_D, "ios", WILD30_D),
            (dict(platform="nxos", line=WILD32), WILD32_D, "ios", HOST_D),
