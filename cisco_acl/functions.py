...
def acls(config: str, **kwargs) -> LAcl:
    ...
    :param str version: Software version (not implemented, planned for compatability)
...
def range_ports(**kwargs) -> LStr:
    ...
    :param str srcports: Range of TCP/UDP source ports
    :param str dstports: Range of TCP/UDP destination ports
    :param str line: ACE pattern, on whose basis new ACEs will be generated
    ...
    :return: Newly generated ACE lines
...
def range_protocols(**kwargs) -> LStr:
    ...
    :param str protocols: Range of IP protocols
    :param str line: ACE pattern, on whose basis new ACEs will be generated
...
def _check_addgr(ace_o, addgrs, address_o, parser) -> bool:
    ...
    False - Address group not found in config, or detected multiple groups with the same name"""
    ace = ace_o.line
